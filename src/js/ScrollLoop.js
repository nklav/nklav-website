...
export default class ScrollLoop extends Loop {
    ...
    scroll() {
        ...
        function scrollMeter(progress) {
            gsap.utils.clamp(1, scrollbar.end - 1, gsap.utils.wrap(0, 1, progress) * scrollbar.end);
        };

        function scrollCircle(iterationDelta, scrollPoint) {
